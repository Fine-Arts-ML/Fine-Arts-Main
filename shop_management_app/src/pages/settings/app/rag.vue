...
import { Cpu, HardDrive, Zap, Loader2, AlertCircle, RefreshCw, Download, Database, Lock, Settings2 } from 'lucide-vue-next'
...
useHead({
  title: 'RAG Search Settings - Art Management',
})
</script>
...
<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Configure semantic search settings. Models are loaded on demand from the shared volume. These settings apply globally to all users.
        </p>
      </div>
      <button
        @click="loadSettings"
    ...
    <Teleport to="body">
      <div v-if="showDownloadConfirm" class="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
    ...
    <Teleport to="body">
      <div v-if="showReindexConfirm" class="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
